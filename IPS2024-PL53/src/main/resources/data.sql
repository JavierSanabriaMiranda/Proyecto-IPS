...
--Insercion de registros en la tabla EQUIPO_PROFESIONAL
DELETE FROM EQUIPO_PROFESIONAL;
INSERT INTO EQUIPO_PROFESIONAL (ID_EQUIPO, ID_PROFESIONAL) VALUES ('EQ00000001', 'EQ00000001');
INSERT INTO EQUIPO_PROFESIONAL (ID_EQUIPO, ID_PROFESIONAL) VALUES ('EQ00000002', 'EQ00000002');
INSERT INTO EQUIPO_PROFESIONAL (ID_EQUIPO, ID_PROFESIONAL) VALUES ('EQ00000003', 'EQ00000003');

-- Inserción de registro en la tabla EMPLEADO_DEPORTIVO
...
VALUES ('JUG001', 'DNI001', 'Juan', 'Pérez', '1990-01-15', '123456789', 50000.00);

INSERT INTO EMPLEADO_DEPORTIVO (ID_EMPLEADO_DEP, DNI, NOMBRE, APELLIDO, FECHA_NACIMIENTO, TELEFONO, SALARIO_ANUAL) 
VALUES ('JUG002', 'DNI002', 'Luis', 'García', '1992-03-20', '987654321', 55000.00);

INSERT INTO EMPLEADO_DEPORTIVO (ID_EMPLEADO_DEP, DNI, NOMBRE, APELLIDO, FECHA_NACIMIENTO, TELEFONO, SALARIO_ANUAL) 
VALUES ('JUG003', 'DNI003', 'Carlos', 'Fernández', '1994-05-30', '456789123', 60000.00);

-- Inserción de registros en la tabla JUGADOR
INSERT INTO JUGADOR (ID_JUGADOR, ID_EQUIPO) VALUES ('JUG001', 'EQ00000001');
INSERT INTO JUGADOR (ID_JUGADOR, ID_EQUIPO) VALUES ('JUG002', 'EQ00000002');
INSERT INTO JUGADOR (ID_JUGADOR, ID_EQUIPO) VALUES ('JUG003', 'EQ00000003');
