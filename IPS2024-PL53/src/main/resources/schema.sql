...
CREATE TABLE HORARIO (
    ...
    CONSTRAINT PK_HORARIO PRIMARY KEY (ID_EMP, COD_HORARIO),
...
CREATE TABLE PRODUCTO(
	...
	CONSTRAIT PK_PRODUCTO PRIMARY KEY (CODPRODUCTO),
...
CREATE TABLE CAMPAÑA_ACCIONISTA(
	...
	CONSTRAINT PK_CAMPAÑA_ACCIONISTA PRIMARY KEY (CODACCIONISTAS),
	CONSTRAINT FK_CAMPAÑA_ACCIONISTA FOREIGN KEY (CODACCIONISTAS)
	REFERENCES VENTAS (ID_VENTAS)
);
