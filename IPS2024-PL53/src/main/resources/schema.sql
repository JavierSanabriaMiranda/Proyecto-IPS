...
CREATE TABLE VENTAS (
    ...
    CONSTRAINT FK_VENTAS_CLIENTE FOREIGN KEY (DNI)  
        ...
        ON DELETE CASCADE                             -- Eliminar ventas si se elimina el cliente
);
...
CREATE TABLE ENTRADA (
    ...
    CONSTRAINT CK_N_FILA CHECK(N_FILA BETWEEN 1 AND 10),
    CONSTRAINT CK_N_ASIENTO CHECK(N_ASIENTO BETWEEN 1 AND 15),
