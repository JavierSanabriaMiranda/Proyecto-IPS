package backend.data.empleados;import java.util.ArrayList;
...
public class DtoAssembler {
	 ...
	 */
	public static List<EmpleadoDeportivo> dtoToEmpleadoDeportivo(List<EmpleadoDTO> dtos) {
	...
	public static List<EmpleadoNoDeportivo> dtoToEmpleadoNoDeportivo(List<EmpleadoDTO> dtos) {
		...
		try {
			...
			throw new IllegalArgumentException("Se ha introducido un valor en la lista de EmpeladoDTO que no es un EmpleadoNoDeportivo");
		}
