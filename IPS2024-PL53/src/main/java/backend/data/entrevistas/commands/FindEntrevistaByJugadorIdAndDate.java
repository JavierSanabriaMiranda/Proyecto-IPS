...
public class FindEntrevistaByJugadorIdAndDate {
	...
	private static final String QUERY = "SELECT "
			...
			+ " FROM ENTREVISTA WHERE FECHA = ? AND ID_JUGADOR = ?";

	public FindEntrevistaByJugadorIdAndDate(String idJugador, Date fecha) {
