...
public class FrameHorariosEmpleados extends JFrame {
	...
	public JList<EmpleadoNoDeportivo> getListEmpleados() {
	...
	public DefaultListModel<EmpleadoNoDeportivo> getModeloList() {
		return modeloList;
	}
	...
	public JDateChooser getClFecha() {
		if (clFecha == null) {
	...
	public JPanel getPnTablaHorario() {
	...
	public JButton getBtAddSemanal() {
	...
	public JRadioButton getRdbtSemanal() {
		if (rdbtSemanal == null) {
	...
	public JRadioButton getRdbtPuntual() {
		if (rdbtPuntual == null) {
	...
	public GestionHorariosShared getGesHor() {
		return gesHor;
	}
}
